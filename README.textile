...
@curl -L https://github.com/russCloak/oh-my-zsh/raw/master/tools/install.sh | sh@


h4. via @wget@:

@wget --no-check-certificate https://github.com/russCloak/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
@git clone git://github.com/russCloak/oh-my-zsh.git ~/.oh-my-zsh@
...
** take a look at the @themes/@ directory and the "wiki":https://wiki.github.com/russCloak/oh-my-zsh/themes to see what comes bundled with @oh-my-zsh@
...
This project wouldn't exist without all of our awesome users and contributors: "view our growing list of contributors":https://github.com/russCloak/oh-my-zsh/contributors
